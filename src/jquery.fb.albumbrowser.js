...
//                            for (a = 8; a >= 0; a--) {
                            for (a = result.data.length-1; a >= 0; a--) {
                                ...
                                var photoLink = $("<a>", { class: "fb-photo-thumb-link", target:"_blank", href: $(result.data)[a].link, "data-fb-page": $(result.data)[a].link });
                                var marginWidth = 0;
                                ...
                                var photoThumb = $("<img>", { style: "margin-left:" + marginWidth + "px;display:none;", "data-id": $(result.data).get(a).id, class: "fb-photo-thumb", "data-src": albumImg.source, src: albumImg.source });
